...
class _CreateProjectDialogState extends State<CreateProjectDialog> {
  ...
  Widget build(BuildContext context) {
    final createProjectCubit = CreateProjectCubit.get(context);
    ...
    return BlocConsumer<CreateProjectCubit, CreateProjectState>(
      listener: (context, state) {
        if (state is CreateProjectSuccess) {
          ...
          customScafoldMessenger(
            context,
            'Project created successfully!'.tr(),
            color: Colors.green,
          );
      ...
      builder: (context, state) {
        ...
        return ModalProgressHUD(
          inAsyncCall: state is CreateProjectLoading,
          child: Dialog(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Add a new project for your team'.tr(),
                  ...
                  GlassButton(
                    ...
                    onPressed: isFormValid
                        ? () {
                            ...
                            createProjectCubit.createProject(
                              nameController.text,
                              descController.text,
                              startDateController.text,
                              endDateController.text,
